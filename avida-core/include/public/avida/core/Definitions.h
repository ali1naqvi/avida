...
enum ePOSITION_OFFSPRING
{
  ...
  POSITION_OFFSPRING_GLOBAL_EMPTY, // for 13 birth_method
  //for 14, birth_methods, test runs
  POSITION_OFFSPRING_BEHAVIORAL_KILL_OFFSPRING, 
  POSITION_OFFSPRING_BEHAVIORAL_KILL_BOTH
};
